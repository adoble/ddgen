#![allow(unused_imports)]
 ...
 use crate::deserialize::Deserialize; use crate::error::DeviceError; use crate::request::{RequestArray, RequestBit, RequestField, RequestWord}; use crate::response::{ResponseArray, ResponseBit, ResponseField, ResponseWord}; use crate::serialize::Serialize; use crate::types::*;
...
a_u16: u16,
 ...
 impl Serialize for BftTestCommandRequest { fn serialize<const N: usize>(&self) -> (u8, [u8; N]) { let mut data = [0u8; N]; data[0].serialize_bit(self.a_bit, 4);
...
a_u16: u16,
 ...
 impl Deserialize<BftTestCommandResponse> for [u8] { fn deserialize(&self) -> Result<BftTestCommandResponse, DeviceError> {
